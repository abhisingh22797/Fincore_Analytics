    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini"><b>Fincore</b>Analytics</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Fincore</b>Analytics</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
              <a href="<?php echo base_url('admin/student_placement/editstudentplacement'); ?>" >
                <i class="fa fa-ticket"></i>
              ...
              <a href="<?php echo base_url('admin/Advisor/editstudentplacement'); ?>" >
                <i class="fa fa-ticket"></i>
                <span>Fincore Advisors</span>
              </a>
            </li>
			 <li>
              <a href="<?php echo base_url('admin/Gyan/editstudentplacement'); ?>" >
                <i class="fa fa-ticket"></i>
                <span>Fincore Gyan (Blog and Report)</span>
              </a>
            </li>
      ...
      <!--      	<li class="treeview">
			...
			<li class="treeview">
              <a href="#">
                <i class="fa fa-share"></i> <span>Target recruiters 
				</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              ...
              <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url('admin/brands/viewbrands');?>"><i class="fa fa-circle-o"></i> View Target recruiters</a></li>
