...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Fincore Advisors
        <small>Edit</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Fincore Advisors Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php
					  ...
					  ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
								  ...
								  <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="slid_title2">LINK</label>
						...
						<!--		<div class="col-md-4">
								...
								<div class="col-md-4">
                                    <div class="form-group">
										...
										<img src="<?php echo  base_url();?>uploads/advisor/<?php echo $allData->slid_img2;?>" height="100px" width="200px">
                                    </div>
                                </div>
                            </div>
															 <div class="row">
								...
								<div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pdes">ABOUT FINANCIAL PLAN</label>
							...
							<h3>FINANCIAL PLANNING: STEP-BY-STEP PROCESS</h3>
								 <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
						...
						<!--		<div class="col-md-4">
							...
							<!--	<div class="col-md-4">
							 ...
							 <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="p6">small description</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="p7">INVESTMENT PRODUCTS</label>
