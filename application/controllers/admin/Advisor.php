...
class Advisor extends BaseController
{
    ...
    function edit($id = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Fincore : Fincore Advisors';
       ...
       if( $this->input->post('submit')!==NULL){
            ...
            /*    if (!empty($_FILES["pi1"]['name'])) {
              ...
              if (!empty($_FILES["pi7"]['name'])) {
                ...
                if($result == true)
                {
                    $this->session->set_flashdata('success', 'Fincore Advisors updated successfully');
                }
                else
                {
                    $this->session->set_flashdata('error', 'Fincore Advisors updation failed');
                }
