...
class Consulting extends CI_Controller
{
    ...
    {
        parent::__construct();
    $this->load->model('frontend/Consulting_model');
	...
	//    $data['test'] =  $this->home_model->getTestimonial();
		$data['contact'] =  $this->Consulting_model->getContact();
	...
	//	$data['allSlider'] = $this->home_model->getAllSliders(); 
     //   $data['aboutInfo'] = $this->home_model->getAbout();	
      //  $data['allHome'] = $this->home_model->getHome();	
       $data['allBarnds'] = $this->Consulting_model->getBrands();
       // $data['promos'] = $this->home_model->getPromos();
       // $data['learnPath'] = $this->home_model->getLearning();
	    $data['allplace'] = $this->Consulting_model->getplace();	
		$data['program'] =  $this->Consulting_model->allprogram(); 		
		
        $data['title'] = 'Fincore Analytics | HR Consulting';
		$data['layout'] = 'Consulting';
